<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Roboto+Slab&size=40&duration=4000&pause=1000&color=1E90FF&center=true&vCenter=true&width=500&lines=Davi+Inácio+Ballestero+Martins;Desenvolvedor+Fullstack;Especialista+em+Cibersegurança;Arquiteto+de+Nuvem+AWS" alt="Header Animation" />
</p>
...
class TechProfile:
    def __init__(self):
        self.nome_completo = "Davi Inácio Ballestero Martins"
        self.idade = 17
        self.formacao = {
...
`Python/Pandas/Flask`  
Solução customizada para automação de workflows administrativos em PMEs, com integração de planilhas e bancos de dados.
